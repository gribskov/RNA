"""=================================================================================================
sample a complete fingerprint from a structure in XIOS XML format using segmentation to keep the
sampling feasible. Copied from fingerprint random

8 April 2026     Michael Gribskov
================================================================================================="""
import sys
import os
import datetime
